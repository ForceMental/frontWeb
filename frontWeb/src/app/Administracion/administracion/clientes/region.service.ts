...
export class RegionService {
  private apiUrl = 'http://107.22.174.168:8000/api/regiones/'; // Ajusta esta URL
  ...
  private handleError(error: HttpErrorResponse) {
    ...
    return throwError('Ocurrió un error al cargar las regiones. Por favor, inténtalo de nuevo más tarde.');
  }
}
